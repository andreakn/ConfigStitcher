...
namespace ConfigStitcher.Stitching
{
    public class XmlStitcher
    {
        public RecipeResult MergeConfigFiles(RecipeInputs inputs, bool enableTrace)
        {
            ...
            var merger = new XmlConfigMerge(enableTrace, "id", "name", "key", "path", "virtualPath", "href", "namespace", "statusCode");
        ...
        public class XmlConfigMerge
        {
            ...
            private readonly bool _enableTrace = false;
            ...
            private static bool HasAttribute(XElement elem, string attributeName)
            {
